...
import com.godfunc.util.MessageFormatUtils;
...
public class GException extends RuntimeException {
    ...
    public GException(Throwable e, String msg, Object... args) {
        super(msg, e);
        this.msg = MessageFormatUtils.format(msg, args);
    }

    public GException(String msg, Object... args) {
        super(msg);
        this.msg = MessageFormatUtils.format(msg, args);
    }
