...
values (1, 0, '/system', 'Layout', 1, '', '系统功能', 1, '', 1, '', '系统功能', 'system', 0, 1),
       (2, 1, 'menu', 'menu/index', 1, '', '菜单管理', 0, '', 1, '', '菜单管理', 'menu', 2, 1),
       (1207275475953606658, 1, 'user', 'user/index', 1, '', '用户管理', 0, 'mg:role:list,mg:role:getByUser', 1, '',
        '用户管理', 'user', 1, 1),
       (1207276248561152001, 1, 'role', 'role/index', 1, '', '角色管理', 0, '', 1, '', '角色管理', 'role', 3, 1),
       (1207276483303763969, 1, 'log', 'log/index', 1, '', '日志', 0, 'mg:log:page', 1, '', '日志', 'log', 4, 1),
       (1207276926083854337, 2, '', 'Button', 2, '', '新增根菜单', 0, 'mg:menu:rootadd,mg:menu:add', 1, '', '', '', 0, 1),
       (1207277652847685634, 0, 'http://localhost:9568/manage/swagger-ui.html', 'Layout', 1, '', '接口文档', 0, '', 1,
        '', '接口文档', 'link', 1, 1),
       (1207312840671674369, 1207275475953606658, '', 'Button', 2, '', '查询', 0, 'mg:user:page', 1, '', '', '', 0, 1),
       (1207312948930854913, 1207275475953606658, '', 'Button', 2, '', '新增', 0, 'mg:user:add', 1, '', '', '', 0, 1),
       (1207313094955548673, 1207275475953606658, '', 'Button', 2, '', '修改', 0, 'mg:user:edit', 1, '', '', '', 0, 1),
       (1207313165424050178, 1207275475953606658, '', 'Button', 2, '', '删除', 0, 'mg:user:remove', 1, '', '', '', 0,
        1),
       (1207315365105811457, 1207276248561152001, '', 'Button', 2, '', '查询', 0, 'mg:role:page', 1, '', '', '', 0, 1),
       (1207315486644158465, 1207276248561152001, '', 'Button', 2, '', '新增', 0,
        'mg:role:add,mg:role:getMenus,mg:menu:getTree', 1, '', '', '', 0, 1),
       (1207315552452788226, 1207276248561152001, '', 'Button', 2, '', '修改', 0,
        'mg:role:edit,mg:role:getMenus,mg:menu:getTree', 1, '', '', '', 0, 1),
       (1207315799031726081, 1207276248561152001, '', 'Button', 2, '', '删除', 0, 'mg:role:remove', 1, '', '', '', 0,
        1),
       (1207474062448738306, 2, '', 'Button', 2, '', '新增', 0, 'mg:menu:add', 1, '', '', '', 0, 1),
       (1207478281733939201, 2, '', 'Button', 2, '', '修改', 0, 'mg:menu:edit', 1, '', '', '', 0, 1),
       (1207478488014004226, 2, '', 'Button', 2, '', '删除', 0, 'mg:menu:remove', 1, '', '', '', 0, 1),
       (1207480932173357057, 1207276483303763969, '', 'Button', 2, '', '查询', 0, 'mg:log:page', 1, '', '', '', 0, 1),
       (1207481715275079681, 2, '', 'Button', 2, '', '查询', 0, 'mg:menu:getAll', 1, '', '', '', 0, 1);
