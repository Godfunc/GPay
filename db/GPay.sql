...
(
    id            bigint(20)   not null,
    channel_code  varchar(64)  not null comment '渠道子类code',
    name          varchar(512) null comment '渠道子类商户名',
    merchant_code varchar(64)  not null comment '渠道子类账号商户号',
...
(
    id            bigint(20)   not null,
    category_code varchar(64) not null comment '渠道主类code',
    channel_code  varchar(64) not null comment '渠道子类code',
    create_id     bigint(20)   not null comment '创建人id',
    update_id     bigint(20)   comment '更新人id',
    ...
    primary key (id),
    unique uq_category_code_channel_code (category_code, channel_code),
...
(
    ...
    pay_category_code varchar(64) not null comment '渠道主类',
    pay_channel_code  varchar(64) not null comment '渠道子类',
    ...
    rm_tag            tinyint(2)   not null default 0 comment '删除标识 0正常 1删除',
    primary key (id),
    index idx_merchant_code_category_code_channel_code (merchant_code, pay_category_code, pay_channel_code),
    index idx_create_time (create_time)
) comment '商户渠道费率';
...
(
    id             bigint(20)   not null,
    merchant_code  varchar(64) not null comment '商户code',
    one_amount_min bigint(20)   not null default -1 comment '单笔最小 -1标识不限制',
    one_amount_max bigint(20)   not null default -1 comment '单笔最大 -1标识不限制',
