...
public class CreateOrderServiceImpl implements CreateOrderService {
    ...
    public PayOrderDTO create(PayOrderParam param, HttpServletRequest request) {
        ...
        detail.setGoodName(param.getGoodName());
        ...
        // 签名返回
        PayOrderDTO payOrderDTO = new PayOrderDTO(order.getOutTradeNo(), order.getOrderNo(), HostUtils.getFullHost(request) + goPayUrl + order.getOrderNo(), detail.getOrderExpiredTime());
